...
public static class SeedDatabase
{
    public static async void Initialize(IApplicationBuilder app)
    {
        ...
        {
            var customer = new AppUser { Name = "Tuana Kondul", UserName = "tuanakondul", Email = "tuanakondul@gmail.com" };
            var admin = new AppUser { Name = "Alican Kondul", UserName = "alicankondul", Email = "alicankondul@gmail.com" };
